...
canvas.bind_all("<Key-r>", color_red)
canvas.bind_all("<Key-o>", color_orange)
canvas.bind_all("<Key-y>", color_yellow)
canvas.bind_all("<Key-g>", color_green)
canvas.bind_all("<Key-b>", color_blue)
canvas.bind_all("<Key-p>", color_purple)
canvas.bind_all("<Key-k>", color_black)
